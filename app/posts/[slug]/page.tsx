...
export default async function SlugPage({
  ...
  return (
    <div className="xl:divide-y xl:divide-gray-200 xl:dark:divide-gray-700">
        ...
        <div className="divide-y-gray-200 pb-8 dark:divide-gray-700 xl:divide-y-0">
            <div className="divide-y divide-gray-200 dark:divide-gray-700 xl:cols-span-3 xl:row-span-2 xl:pb-0">
